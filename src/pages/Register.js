...
const SKILL_SUGGESTIONS = [
  ...
  "DSA", "MongoDB", "SQL", "UI/UX", "DevOps","others"
];
...
export default function Register() {
  ...
  const handleRoleSelect = (selectedRole) => {
    setForm({
      ...form,
      role: selectedRole,
      roles: selectedRole === "both" ? ["mentor", "mentee"] : [selectedRole],
    });
  };
    ...
    <div className="auth-page">
      ...
      >
        <div className="auth-hero">
          ...
          <h1 className="logo-gradient">MentorMatch</h1>
          <p style={{ color: "var(--text-dim)" }}>
            Join as a mentor or mentee.<br />Build your future together.
          </p>
        ...
        <div className="auth-card">
            ...
            <div className="auth-form">
              ...
              <div className="form-group">
                ...
                <div className="role-select">
                  <button type="button" className={`role-btn ${form.role === "mentee" ? "active-mentee" : ""}`} onClick={() => handleRoleSelect("mentee")}>
                    🎓 Mentee<small>I need guidance</small>
                  </button>
                  <button type="button" className={`role-btn ${form.role === "mentor" ? "active-mentor" : ""}`} onClick={() => handleRoleSelect("mentor")}>
                    🏆 Mentor<small>I offer guidance</small>
                  </button>
                  <button type="button" className={`role-btn ${form.role === "both" ? "active-mentor" : ""}`} onClick={() => handleRoleSelect("both")}>
                    🔄 Both<small>Mentor + Mentee</small>
                  </button>
                </div>
              </div>
              <button
          ...
          {step === 2 && (
            <form onSubmit={handleSubmit} className="auth-form">
              <div className="form-group">
                <label>Bio</label>
                <textarea name="bio" placeholder="Tell something about yourself..." value={form.bio} onChange={handleChange} />
              </div>
              <div className="form-group">
                <label>Domain / Field</label>
                <input name="domain" placeholder="Web Dev / AI / Design..." value={form.domain} onChange={handleChange} />
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="suggestions">
                  {SKILL_SUGGESTIONS.map((skill) => (
                    <span key={skill} className="badge" onClick={() => addSkill(skill)} style={{ cursor: "pointer" }}>
                      {skill}
                    </span>
                  ))}
                </div>
